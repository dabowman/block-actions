...
class Theme_Action extends Action_Renderer {
	 ...
	 * discovery list so both directive injection and on-demand enqueue are
	 * O(1) per render rather than re-scanning the list for every block that
	 * carries a theme action.
	 *
	 * @since 3.0.0
	 *
